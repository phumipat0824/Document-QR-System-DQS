                     ...
                     <div class="row gx-5">
                         ...
                         <div class="col-10">
                             <div class="row justify-content-md-center">
                                 ...
                                 <div class="col-md-10 justify-content-md-center">
                                     <div class="card-header card-header-warning" style="padding: 10px; border-radius: 10px;">
                                         ...
                                         <h2 class="text-center" style="color:#fff; font-family:TH Sarabun New; font-size: 45px;">สมัครสมาชิก</h2>
                             ...
                             <form action='<?php echo site_url() . 'Member/Member_register/insert_session' ?>' id="form_id" method="post" name='form'>
                                 ...
                                 <div class="row gx-5">
                                     <!-- เลือกคำนำหน้าชื่อแบบ dropdown list -->
                                     <div class="col">
                                 ...
                                 <div class="row gx-5">
                                     <!-- กรอก Email ลงในกล่องบันทึกข้อความ -->
                                     <div class="col-4">
                                     ...
                                     <div class="form-group col-md-4">
                                         <!-- กรอกรหัสผ่านลงใน กล่องบันทึกข้อความ -->
                                     ...
                                     <div class="form-group col-md-4">
                                         <!-- กรอกรหัสยืนยันรหัสผ่านลงใน กล่องบันทึกข้อความ -->
