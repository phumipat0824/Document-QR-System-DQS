      ...
      <ul class="nav nav-tabs">
        ...
        <div class="row">
            ...
            <div class="card" style=" margin-left: 10%; width:640%">
              <input id="file" type="file" placeholder="อัปโหลดไฟล์" style="padding: 10px; width: 230px; height: 50px;"><br>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-2 offset-md-1">
              <input id="text" type="text" style="margin: 0px;  width: 400px;" value="" placeholder="ชื่อไฟล์"><br />
            </div>
          </div>
