...
class Da_DQS_download extends DQS_model
{
    ...
    {
        $sql = "INSERT INTO {$this->db_name}.DQS_Download(dow_download,dow_datetime,dow_qr_id) 
                    VALUES (?,?,?)";

        $this->db->query($sql, array($this->dow_download, $this->dow_datetime, $this->dow_qr_id));
    }
