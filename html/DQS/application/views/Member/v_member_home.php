             ...
             <div class="dropdown">
                 ...
                 <div id="showmenu" style="display:block">
                     <div id="folder<?php echo $arr_fol[$i]->fol_id ?>" class="dropdown-content">
                         ...
                         <a href="#" class="moveModal" data-toggle="modal" data-target="#moveModal" id="optionMoveModal"
                             onclick="createDropdown('folder')" data-id="<?php echo $arr_fol[$i]->fol_id ?>"
...
*/ -->
 ...
 <div class="row" style="padding: 100px 10px 10px 20%;">
                 ...
                 <div class="form-row">
                     ...
                     <div class="form-group col-md-2">
                         ...
                         <a href="#" class="EditFileModal" data-toggle="modal" data-target="#EditFileModal"
                             data-id="<?php echo $arr_qr[$i]->qr_id ?>" data-name="<?php echo $arr_qr[$i]->qr_name ?>">
                             <button id="edit" class="btn btn-"
                                 style="background-color: #100575; font-family:TH sarabun new; color:#FFFFFF; font-size: 20px; width: 70px; ">แก้ไข</button></a>
                                         ...
                                         <div class="modal-body">
                                             <center>
                                                 <input onkeyup="check_file_edit()" type="text" class="col-md-10"
                                                     id="qr_name" placeholder="" name="qr_name" value="" required>
                                             </center>
                                             <br>
                         ...
                         <!-- End EditFile Model -->
                         <button type="button" id="move" class="btn btn- MoveFileModal" onclick="createDropdown('file')"
                             data-toggle="modal" data-target="#MoveFileModal"
                             data-id="<?php echo $arr_qr[$i]->doc_id ?>" data-name="<?php echo $arr_qr[$i]->doc_name ?>"
                         ...
                         <a href="#" class="deleteFileModal" data-toggle="modal" data-target="#deleteFileModal"
                             onclick="set_delete('<?php echo $arr_doc[$i]->doc_path ?>',<?php echo $arr_doc[$i]->doc_id ?>,'<?php echo $arr_qr[$i]->doc_fol_id ?>')">
                             <button id="delete" class="btn btn-"
                                 style="background-color:#E02D2D; font-family:TH sarabun new; color:#FFFFFF; font-size: 20px; width: 70px; ">
                                 ลบ</button></a>
             ...
             <div class="card-body">
                 <div class="form-row">
                     ...
                     <div class="form-group col-md-2">
                         ...
                         <a href="#" class="EditFileModal2" data-toggle="modal" data-target="#EditFileModal2"
                             data-id="<?php echo $arr_qr[$i]->qr_id ?>" data-name="<?php echo $arr_qr[$i]->qr_name ?>"
                             data-doc_fol="<?php echo $arr_qr[$i]->doc_fol_id ?>">
                             <button id="edit2" class="btn btn-"
                                 style="background-color: #100575; font-family:TH sarabun new; color:#FFFFFF; font-size: 20px; width: 70px; ">แก้ไข</button></a>
                         <!-- EditFile Modal -->
                         <div class="modal fade" id="EditFileModal2" tabindex="-1" role="dialog"
                             aria-labelledby="exampleModalLabel" aria-hidden="true">
                             <div class="modal-dialog" role="document">
                                 <div class="modal-content">
                                     <div class="modal-header">
                                     ...
                                     <form id="edit-form" method="POST"
                                         ...
                                         <div class="modal-body">
                                             <center>
                                                 <input onkeyup="check_file_edit_in_folder()" type="text"
                                                     class="col-md-10" id="qr_name" placeholder="" name="qr_name"
                                                     value="" required>
                                             </center>
                                             <br>
                                             <a id="edit_mss" style="display: none; color:red;"
                         ...
                         <a href="#" class="delete2FileModal" data-toggle="modal" data-target="#delete2FileModal"
                             ...
                             <button id="delete" class="btn btn-"
                                 ...
                                 ลบ</button></a>
                         <!-- deleteFile Modal -->
                         <div class="modal fade" id="delete2FileModal" tabindex="-1" role="dialog"
                             aria-labelledby="exampleModalLabel" aria-hidden="true">
                             <div class="modal-dialog" role="document">
                                 <div class="modal-content">
                                     <div class="modal-header">
    ...
    */ -->
     <!-- Move File Modal -->
     <div class="modal fade" id="MoveFileModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
         aria-hidden="true">
         <div class="modal-dialog" role="document">
             <div class="modal-content">
                 <div class="modal-header">
