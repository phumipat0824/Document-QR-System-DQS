     ...
     <div class="row" style="padding: 100px 10px 10px 20%;">
         ...
         <div class="col-md-4">
             <div class="dropdown">
                 ...
                 <div id="myDropdown" class="dropdown-content">
                     ...
                     <<<<<<< HEAD <div class="custom-cm__item"><a
                 ...
                 <div class="custom-cm__item"><a
                     ...
                     <div class="custom-cm__item"><a
                             href="<?php echo site_url() . '/Member/Member_upload_file/show_member_upload_file_in_floder/' . $this->session->userdata('fol_id'); ?>">อัปโหลดไฟล์</a>
                         >>>>>>> ab7bc3c7b1210c7520b0102f40911bcec3a4c73c
                     </div>
                     <?php } ?>
                 </div>
             </div>
         ...
         <div>
             <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                 ...
                 <?php if ($path_fol[$i] != '@') { ?>
                 <<<<<<< HEAD <li class="breadcrumb-item text-sm text-dark active" style="font-size: 20px;"><a
         ...
         <div class="col-3">
             ...
             <div class="dropdown">
                 ...
                 <!--  โฟลเดอร์พิเศษ -->
                 <<<<<<< HEAD <button onmousedown="rightclickfolder(<?php echo $arr_fol[$i]->fol_id ?>)"
                     ...
                     <div id="showmenu" style="display:block">
                         <div id="folder<?php echo $arr_fol[$i]->fol_id ?>" class="dropdown-content">
                             ...
                             <button onmousedown="rightclickfolder(<?php echo $arr_fol[$i]->fol_id ?>)"
                                 class="dropbtn btn btn-secondary btn-lg"
                                 style=" background-color:#a19078; border: 2px solid #876a43; height: 60px; width: 300px;">
                                 <img src="<?php echo base_url() . '/assets/image/foldersecurity.png' ?>" height="35"
                                     width="35" style="margin-left: -20px;">
                                 <a style=" font-size: 26px; font-weight:900; font-family:TH Sarabun New; margin-right: 300px;"
                                     class="menu"><?php echo $arr_fol[$i]->fol_name ?></a>
                             </button>
                             <div id="showmenu" style="display:block">
                                 ...
                                 <div id="showmenu" style="display:block">
                                     <div id="folder<?php echo $arr_fol[$i]->fol_id ?>" class="dropdown-content">
                                         ...
                                         <button onmousedown="rightclickfolder(<?php echo $arr_fol[$i]->fol_id ?>)"
                                             class="dropbtn btn btn-secondary btn-lg"
                                             style=" background-color:#4876d3; border: 2px solid #002b83; height: 60px; width: 300px;">
                                             <img src="<?php echo base_url() . '/assets/image/foldersecurity.png' ?>"
                                                 height="35" width="35" style="margin-left: -20px;">
                                             <a style=" font-size: 26px; font-weight:900; font-family:TH Sarabun New; margin-right: 300px;"
                                                 class="menu"><?php echo $arr_fol[$i]->fol_name ?></a>
                                         </button>
                                         <div id="showmenu" style="display:block">
                                             <div id="folder<?php echo $arr_fol[$i]->fol_id ?>"
                            ...
                            ?>
                                         ...
                                         <<<<<<< HEAD <button
                                             onmousedown="rightclickfolder(<?php echo $arr_fol[$i]->fol_id ?>)"
                                             ...
                                             <i class="material-icons"
                                                 style="margin-left: -20px; font-size:30px;  color:#f3ff41;">folder</i>
                                             <a style=" font-size: 26px; font-weight:900; font-family:TH Sarabun New; margin-right: 300px;"
                                                     ...
                                                     <div class="modal-content">
                                                         <div class="modal-header">
                                                             <h1 class="modal-title" id="exampleModalLabel"
                                                                 style="font-weight: 900;font-size: 36px; font-family:TH Sarabun New;">
                                                                 โฟลเดอร์ใหม่</h1>
                                                         ...
                                                         <form method="POST" name="form"
                                                             ...
                                                             <div class="modal-body">
                                                                 <center><input
                                                                         style="font-size: 25px;font-family:TH Sarabun New; "
                                                                         id="fol_name" type="text" class="col-md-10"
                                                                         placeholder="โฟลเดอร์ไม่มีชื่อ" name="fol_name"
                                                                         required></center><br>
                                                                 <a id="target_div" style="display: none; color:red;"
                                                                     align='center'>ชื่อโฟลเดอร์ซ้ำ
                                                                     กรุณากรอกใหม่</a>
                                                 ...
                                                 <div class="modal-dialog" role="document">
                                                     <div class="modal-content">
                                                         ...
                                                         <form id="delete-form" method="POST"
                                                             ...
                                                             <div class="modal-body">
                                                                 <input type="hidden" name="fol_id" id="fol_id"
                                                                     value="">

                                                                 <input type="hidden" name="fol_location_id"
                                                                     id="fol_location_id"
                                                                     value="<?php echo $arr_fol[0]->fol_location_id; ?>">
                                                             </div>
                                                             <div class="modal-footer">
                                             ...
                                             <div class="modal fade" id="editModal" tabindex="-1" role="dialog"
                                                 ...
                                                 <div class="modal-dialog" role="document">
                                                     <div class="modal-content">
                                                         <div class="modal-header">
                                                             <h5 class="modal-title" id="exampleModalLabel">
                                                                 แก้ไขชื่อโฟลเดอร์</h5>

                                                         </div>
                                                         <form id="edit-form" method="POST"
                                                             action="<?php echo site_url() . '/Folder/Folder_management/update_folder/'; ?>">
                                                             <div class="modal-body">
                                                                 <center><input onkeyup="check_fol_edit()" type="text"
                                                                         class="col-md-10" id="fol_edit" placeholder=""
                                                                         name="fol_name" required></center>
                                                                 <br>
                                                                 <a id="edit_mss" style="display: none; color:red;"
                                                                     align='center'>กรุณากรอกข้อมูลใหม่</a>
                                                                 <input type="hidden" name="fol_id" id="folder_id"
                                                                     value="">
                                                                 <input type="hidden" name="fol_location_id"
                                                                     id="fol_location_id"
                                                                     value="<?php echo $arr_fol[0]->fol_location_id; ?>">
                                                             ...
                                                             <div class="modal-footer">
                                                                 <button type="button" class="btn btn-danger"
                                                                     data-dismiss="modal">ยกเลิก</button>
                                                                 <input type="submit" class="btn btn-success" id="edit"
                                                                     value="บันทึก">
                                                             </div>
                                                         </form>
                                                     </div>
...
*/ -->
                                             ...
                                             <div class="modal fade" id="moveModal" tabindex="-1" role="dialog"
                                                 ...
                                                 <div class="modal-dialog" role="document">
                                                     <div class="modal-content">
                                                         <div class="modal-header">
                                                             <h5 class="modal-title" id="exampleModalLabel">ย้ายไปที่
                                                             </h5>
                                                         </div>
                                                         <form id="move-form" method="POST"
                                                             ...
                                                             <div class="modal-footer">
                                                                 ...
                                                                 <input type="submit" class="btn btn-success"
                                                                     value="บันทึก">
                                                                 <input type="hidden" name="fol_id" id="fold_id"
                                                                     value="">
                                                                 <input type="hidden" name="fol_name" id="folder_name"
                                                                     value="">
                                                             </div>
                                                         </form>
                                                     </div>
                                 ...
                                 <div class="row" style="padding: 100px 10px 10px 20%;">
                                     <h3 style="color:#707070; font-family:TH Sarabun New; font-weight: 900;">
                                         คิวอาร์โค้ด</h3>
                                     ...
                                     <div class="col-md-4">
                                         <div class="card" id="card-qrcode"
                                             style="padding-top: 10px; border-radius: 10px; ">
                                             ...
                                             <div class="card-body">
                                                 <div class="form-row">
                                                     <div class="form-group col-md-4" id="qrcode">
                                                         <img id="img"
                                                             src="<?php echo base_url() . $arr_qr[$i]->qr_path ?>"
                                                     ...
                                                     <div class="form-group col-md-4">
                                                         ...
                                                         <h5
                                                             style="color:#000000; font-family:TH Sarabun New; font-size: 20px;">
                                         ...
                                         <div class="modal-dialog" role="document">
                                             <div class="modal-content">
                                                 ...
                                                 <form id="edit-form" method="POST"
                                                     ...
                                                     <div class="modal-body">
                                                         <center>
                                                             <input onkeyup="check_file_edit()" type="text"
                                                                 class="col-md-10" id="qr_edit" placeholder=""
                                                     ...
                                                     <div class="modal-footer">
                                                         <button type="button" class="btn btn-danger"
                                                             data-dismiss="modal">ยกเลิก</button>
                                                         <input type="submit" class="btn btn-success" id="sub_edit"
                                                             value="บันทึก">
                                                     </div>
                                                 ...
                                                 <form id="move-form" method="POST"
                                                     ...
                                                     <div class="modal-body">
                                                         ...
                                                         <select name="doc_fol_id" id="doc_fol_id" class="form-select"
                                                             aria-label="Default select example" placeholder=""
                                                             required>
                                                             <option value="" disabled selected hidden>เลือกโฟลเดอร์
                                                             </option>
                                     ...
                                     $.ajax({
                                         ...
                                         success: function(json_data) {
                                             ...
                                             if (obj_level[1].length == 0) {
                                                 ...
                                                 //กรณีไม่มีข้อมูล
                                                 html_option =
                                                     ' <option value="none">ไม่พบข้อมูล</option>';
                                                 $('#folder_location_id').html(html_option);
                                             } //if
                                             else {
                                                 ...
                                                 let prefix =
                                                 '&nbsp'; //สัญลักษณ์ข้างหน้าแต่ละ level
                                                 ...
                                                 for (level = 1; level <= max_level; level++) {
                                                     ...
                                                     if (level == 1) {
                                                         html_option =
                                                             '<option value="" disabled selected hidden>เลือกโฟลเดอร์</option>';
                                                         for (i = 0; i < obj_level[level]
                                                             .length; i++) {

                                                             //ลูกของตัวที่ถูกเลือก จะต้องกดไม่ได้
                                                             let disable = '';
                                                             if (obj_level[level][i]["fol_location"]
                                                                 .includes(current_path + '/') ||
                                                                 obj_level[level][i][
                                                                 "fol_location"] == current_path) {
                                                                 disable = ' disabled ';
                                                             } //if

                                                             html_option += '<option ' + disable +
                                                                 ' id="fol_' + obj_level[level][i][
                                                                     "fol_id"
                                                                 ] + '" value="' + obj_level[level][
                                                                     i
                                                                 ]["fol_id"] + '">';
                                                             html_option += obj_level[level][i][
                                                                 "fol_name"
                                                             ];
                                                             html_option += '</option>';
                                                         ...
                                                         if (level == 2) {
                                                             ...
                                                             html_option = '<option value="0"' +
                                                                 disable + ' > หน้าหลัก</option>';
                                                             $('#folder_location_id').prepend(
                                                                 html_option);
                                                         } //if
                                                         ...
                                                         for (i = obj_level[level].length - 1; i >=
                                                             0; i--) {
                                                             ...
                                                             html_option += prefix + ' ' +
                                                                 obj_level[level][i]["fol_name"];
                                                             html_option += '</option>';


                                                             //แทรกโค้ดลูก หลังจากตำแหล่งโค้ดแม่
                                                             var tag_parent = document
                                                                 .getElementById('fol_' + obj_level[
                                                                     level][i][
                                                                     "fol_location_id"]);
                                                             tag_parent.insertAdjacentHTML(
                                                                 'afterend', html_option);
                                                         } //for
                                                     } //else
