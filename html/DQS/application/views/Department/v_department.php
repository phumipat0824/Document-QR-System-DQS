                            ...
                            <div class="row">
                                ...
                                <div class="col-2">
                                    <button class="btn btn-success" data-toggle="modal" data-target="#addModal">+
                                        เพิ่มหน่วยงาน</button> <!-- ปุ่มเพิ่มหน่วยงาน -->
...
function create_Table(arr_dept) {
    ...
    arr_dept.forEach((row_dept, index_dept) => {
        ...
        html_code += '<input type="checkbox"  ' + check_status + ' onchange="update_status(' + row_dept[
            'dep_id'] + ',' + row_dept['dep_active'] + ')" >';
        html_code += '<span class="slider round"></span>';
        html_code += '</label>';
        html_code += '</td>';

        html_code += '<td style="text-align: center;">' + '<button class="btn btn-orange ">' +
